    ...
    */
    if (accountObj != null && !balanceAddedSuccess) {
        ...
        if (accountObj instanceof Account) {
            ...
            // Account model has no holder-name field - only the
            // Map branch below (the actual path used by AdminDAO.findAccount())
            // has it, via the users JOIN.
            holderName = "";
            ...
            holderName = getMapValue(accountMap, "full_name", "fullName", null);
            ...
            <div class="balance-search-card">
                ...
                <div class="balance-section-head">
                    <div>
                        ...
                        <p>Enter account number or customer ID.</p>
                    </div>
                ...
                <form method="get" action="${pageContext.request.contextPath}/admin/add-balance">
                    ...
                    <div class="balance-search-grid">
                        ...
                        <div class="balance-field">
                            <label>OR Customer ID</label>

                            <div class="balance-input-wrap">
                                <i class="bi bi-person-badge"></i>
                                <input type="text"
                                       name="customerId"
                                       placeholder="Example: 2899207035"
                ...
                <div class="balance-account-card">
                    ...
                    <div class="balance-detail-grid">
                        ...
                        <div class="balance-detail-box full">
                            ...
                            <strong><%= holderName.isEmpty() ? "-" : holderName %></strong>
                        </div>
